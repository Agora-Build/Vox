...
export default function ConsoleEvalJobDetail({ jobId }: { jobId: number }) {
  ...
  const reportHtml = artifactFiles.find(f => f.name.endsWith('report.html') || f.name.endsWith('/report.html'));
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>Generated by aeval analysis pipeline</CardDescription>
            </div>
            <a href={reportHtml.url} target="_blank" rel="noopener noreferrer">
