...
- One eval framework: **aeval** (`aeval run scenario.yaml` → `metrics.json`); voice-agent-tester was removed 2026-09 (`config.framework` must be `aeval`, the `app` config key is rejected)
