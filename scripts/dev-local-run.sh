...
show_status() {
    ...
    echo "    GET  $SERVER_URL_DISPLAY/api/eval-flows          - List evalFlows"
    echo "    POST $SERVER_URL_DISPLAY/api/eval-flows          - Create evalFlow"
    echo "    POST $SERVER_URL_DISPLAY/api/eval-flows/:id/run  - Run evalFlow"
