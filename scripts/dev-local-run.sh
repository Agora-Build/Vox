...
show_status() {
    ...
    echo "    GET  $SERVER_URL_DISPLAY/api/evalflows          - List evalflows"
    echo "    POST $SERVER_URL_DISPLAY/api/evalflows          - Create evalflow"
    echo "    POST $SERVER_URL_DISPLAY/api/evalflows/:id/run  - Run evalflow"
